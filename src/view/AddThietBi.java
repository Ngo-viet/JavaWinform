...
public class AddThietBi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        boxLoaiThietBi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Màn hình", "Case máy tính", "Chuột", "Bán phím" }));
    ...
    private void ThemCaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThemCaActionPerformed
        ...
        if (isOk) {
            ThietBi tb = new ThietBi( maTB,  tenTB,  loaiTB,  soHD,  soLoi,  namSX, tenPhong);
            home.addThietBi(tb);
